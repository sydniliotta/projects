...
<body>
  <div class="container">
    ...
    <p>
      This project tracks how many patients received flu shots in 2023. I used SQL to extract and transform data from our hospital system, and then created visualizations in Tableau. The SQL query below pulls data for active patients (those with encounters from 2020 to 2023, who are alive, and are at least 6 months old as of December 31, 2023) and identifies the earliest flu shot each patient received in 2023.
    </p>
    <h2>SQL Code</h2>
    <pre><code>
